...
In addition to designing cars using tools such as Autocad, Solidworks, UG, Creo, Adams, Patran, I took part in the development of programs in the Delphi language for solving applied engineering problems for long time.

Now I have decided to change my profession and join the entire IT community. 
...
In the future, I want to connect my life with the development of web applications.

Now I am learing HTML, CSS, JavaScript and English (skill level A1 by EPAM test) on my own. 
